            ...
            <div class="modal-content bg-white p-8 rounded-lg shadow-lg overflow-auto max-w-md w-full max-h-[80vh]">
                ...
                <form action="{{ route('program-lists-new-program') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" id="total_units" name="total_units" value="0" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    </div>
                ...
                <div x-show="updateModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center px-4 z-50">
                    <div class="modal-content bg-white p-8 rounded-lg shadow-lg overflow-auto max-w-md w-full">
                        ...
                        <form :action="'/admin/functions/program-course-management/program_list/update-program/' + selectedProgram" method="POST">
                            ...
                            <div>
                                <label for="total_units" class="block text-sm font-medium text-gray-700">Total Units:</label>
                                <input type="number" x-model="selectedTotalUnits" name="total_units" value="0" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            </div>
